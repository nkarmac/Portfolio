  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          The following projects are publically available examples reflecting my work.<br/>
          Feel free to explore them. The github icon links to their source code as well.
        </motion.p>
      </div>
